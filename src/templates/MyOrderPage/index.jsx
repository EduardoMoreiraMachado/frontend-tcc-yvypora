            ...
            <LoadScript googleMapsApiKey='AIzaSyCQfb1qbVCwR8biTe469v_uBuVWaO9JxtY'>
              <div className={styles['route-container']}>
                <Route
                  ...
                  destination={order?.route?.arrived ? order.route.arrived : [0,0]}
                  origin={order?.route?.origin? order.route.origin : [0,0]}
                  waypoints={order?.route?.waypoints ? order.route.waypoints : [[0,0]]}
                />
              </div>
              {deliveryman ? (
                <>
