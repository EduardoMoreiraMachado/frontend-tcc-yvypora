            ...
            <div className={styles['welcome-container']}>
                <div className={styles['welcome-message']}>
                    <h1 className={styles['welcome-text']}>
                        Boas-vindas ao <span className={styles['strong-welcome-text']}>yvyporã</span>, a sua feira digital!
                    </h1>
                    <div className={styles['welcome-image']}></div>
                </div>
                <div className={styles['user-select']}>
                    <h1 className={styles['user-select-text']}>Como você usará a plataforma?</h1>
