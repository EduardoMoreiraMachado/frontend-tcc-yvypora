...
import FiltersIcon from '../../imgs/filters_icon.png'
...
export const ProductsFilters = ({ categories, setListOfProducts, setSearchValue}) => {
  ...
  return (
    <>
      <div className={styles['filters-icon']} style={{backgroundImage: `url(${FiltersIcon})`}} onClick={handleClickFilters}></div>
      {filtersClick && (
        <div className={styles['products-filters-container']}>
          <div className={styles['up-container']}>
            ...
            <div className={styles['rating-filter']}>
              ...
              >
                <img id={0} className={styles['star-icon']} src={StarIcon} alt=''/>
              ...
              <button
                ...
                onClick={handleClickInStars}
              >
                <img id={1} className={styles['star-icon']} src={StarIcon} alt='' />
              ...
              <button
                ...
                onClick={handleClickInStars}
              >
                <img src={StarIcon} className={styles['star-icon']} alt='' id={2} />
              ...
              <button
                ...
                onClick={handleClickInStars}
              >
                <img src={StarIcon} className={styles['star-icon']} alt='' id={3} />
              ...
              <button
                ...
                onClick={handleClickInStars}
              >
                <img src={StarIcon} className={styles['star-icon']} alt='' id={4} />
              ...
              <button
                ...
                onClick={handleClickInStars}
              >
                <img src={StarIcon} className={styles['star-icon']} alt='' id={5} />
                <h2 id={5}>5 apenas</h2>
              </button>
            </div>
          </div>
